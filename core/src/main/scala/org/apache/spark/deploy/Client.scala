    ...
    driverArgs.cmd match {
      case "launch" =>
        ...
        val driverDescription = new DriverDescription(
          ...
          command)
        //向master发送消息
        ayncSendToMasterAndForwardReply[SubmitDriverResponse]( RequestSubmitDriver(driverDescription))
...
object Client {
  def main(args: Array[String]) {
    ...
    //得到marster的url,并得到master的Endpoint,用于同master通信
